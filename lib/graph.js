...
UndirectedGraph.prototype = {
	...
	addEdge: function(from, to){
		if(this.hasVertex(from) && this.hasVertex(to)){
			...
			// this.vertexes[from] = this.vertexes[from] 
			// 						&& this.vertexes[from].concat(to) || [] ;
			// this.vertexes[to] = this.vertexes[to] 
			// 						&& this.vertexes[to].concat(from) || []; 	
